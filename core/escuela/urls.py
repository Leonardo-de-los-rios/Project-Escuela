...
urlpatterns = [
    ...
    path('modificar-preceptor/<str:pk>', views.modificar_preceptor, name='modificar_preceptor'),
    path('modificar-aula/<str:pk>', views.modificar_aula, name='modificar_aula'),
    path('modificar-alumno/<str:pk>', views.modificar_alumno, name='modificar_alumno'),
    path('modificar-materia/<str:pk>', views.modificar_materia, name='modificar_materia'),
    ...
    path('eliminar-preceptor/<str:pk>', views.eliminar_preceptor, name='eliminar_preceptor'),
    path('eliminar-aula/<str:pk>', views.eliminar_aula, name='eliminar_aula'),
    path('eliminar-alumno/<str:pk>', views.eliminar_alumno, name='eliminar_alumno'),
    path('eliminar-materia/<str:pk>', views.eliminar_materia, name='eliminar_materia'),
